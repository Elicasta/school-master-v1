...
import { getScores, getMemoryCards } from "@/lib/local-store";
  ...
  return (
    <div className="px-5 py-8 md:px-10 md:py-10 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        ...
        <StatCard label="Debate score" value={`${scores.debateScore}`} sub={`${scores.debateWins}W - ${scores.debateLosses}L`} />
        <StatCard label="Memory streak" value={`${scores.memoryStreak}`} sub="sessions" />
